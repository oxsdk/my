#
#  Be sure to run `pod spec lint OXSaiSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "oxsdk" => "120862840@qq.com" }

  s.social_media_url   = "http://my.wlwx.com/site/index.html"
  ...
  s.source       = { :git => "https://github.com/oxsdk/my.git", :tag => s.version.to_s }
